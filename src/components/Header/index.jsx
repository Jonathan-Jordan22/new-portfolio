  ...
  return (
    <header ref={ref}>
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} className="header--top">
        <h3>
          <a href="https://github.com/Jonathan-Jordan22" target={"_blank"} rel="noopener noreferrer">
            <ScrambleText shuffle delay={0.5}>
              GITHUB
            </ScrambleText>
          </a>
          <span className="header--hash">{"//"}</span>
          <a href="https://www.linkedin.com/in/jonathan-jordan-ab7719361" target={"_blank"} rel="noopener noreferrer">
      ...
      <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 4 }} className="header--bottom">
        <div>
          ...
          <p className="theme--detail">
            <ScrambleText shuffle delay={4}>
              Hey, I’m Jonathan! 🚀 I love building sleek, modern web apps that feel effortless to use. Whether it’s designing smooth user experiences, solving tricky frontend challenges, or experimenting with new tools, I’m always pushing myself to learn and create better. My goal? To craft technology that makes people’s lives simpler, smarter, and more enjoyable.
            </ScrambleText>
          </p>
        </div>
      ...
      <h1 className="header--name">
        <TextWriting controls={controls} text={"Jonathan Jordan"} noblink />
        <br />
